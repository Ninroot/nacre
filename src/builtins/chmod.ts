...
import { addPerm, removePerm, getMode, setMode, modeToOctal } from './lib/_chmod';
import {platform} from "process";

// GET
const chmod: any = (itemPath) => getMode(itemPath);
...
// disable chmod for windows
export = (platform === 'win32') ? undefined : chmod;
